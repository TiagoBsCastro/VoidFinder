...
/home/tcastro/miniforge3/envs/voidfinder/bin/python scripts/compare_void_size_functions.py \\
  ...
  --bin-min 10 \\
  --bin-max 80 \\
  --output-csv runs/void-statistics/n256_mcmc_best_fit_paper_bins_vsf.csv \\
  --summary-csv runs/void-statistics/n256_mcmc_best_fit_paper_bins_vsf_summary.csv \\
  --output-plot runs/void-statistics/n256_mcmc_best_fit_paper_bins_vsf.png
"""
    path.parent.mkdir(parents=True, exist_ok=True)
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-prefix",
        type=Path,
        default=Path("runs/void-statistics/n256_vsf_mcmc"),
    )
    parser.add_argument(
        "--allow-degenerate",
        action="store_true",
